...
//  FoodTracker
//
//  Created by Jun Oh on 2019-02-18.
...
class MealTableViewController: UITableViewController {
  ...
  private func loadMeals() -> [Meal]? {
    do {
      let loadData = try Data(contentsOf: Meal.ArchiveURL)
      return try NSKeyedUnarchiver.unarchiveTopLevelObjectWithData(loadData) as? [Meal]
    } catch {
